    ...
    <div className="flex flex-col items-center w-full max-w-lg mx-auto mt-10">
      <div className="flex flex-col md:flex-row gap-8">
        <div className="relative">
          ...
          >
            <div className="group-hover/product:bg-yellow-500/50 w-16 h-16 bg-yellow-100 rounded-full flex items-center justify-center duration-300 ">
              <Package />
            </div>
        ...
        <div className="relative">
          ...
          <button
            ...
            className="flex flex-col items-center justify-center gap-5 bg-purple-400 hover:bg-purple-300 duration-300 p-10 rounded h-56  w-56 group"
          >
      ...
      <button
        disabled={!source}
        onClick={() => setStep(2)}
        className={`bg-black w-full max-w-[calc(2*14rem+2rem)] py-3 font-bold mt-5 duration-300 rounded-full text-white hover:bg-black/80 ${
