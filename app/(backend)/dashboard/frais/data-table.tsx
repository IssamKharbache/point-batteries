...
interface DataTableProps<TData, Cost> {
  columns: ColumnDef<TData, Cost>[];
  data: TData[];
  name: string;
}

export function DataTable<TData extends Cost>({
  columns,
  data,
  name,
}: DataTableProps<TData, Cost>) {
      ...
      <div className="rounded-md border ">
        <div className="flex flex-col md:flex-row justify-between md:items-center  border-b ">
          ...
          <div className="relative flex items-center py-4">
            <Input
              placeholder="Filtrer par nature des frais..."
              value={
                (table
                  .getColumn("natureDuFrais")
